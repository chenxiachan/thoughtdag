...
export const en = {
  ...
  'landing.quickDesc': 'The example canvas needs no setup; for your own conversations, start with the easiest door',
  'landing.quickPrimary': 'Use your ChatGPT plan',
  ...
  'tutorial.step2.desc': 'A follow-up grows a solid-wired child. The AI sees exactly what flows in along the arrows. The one rule: a wire IS context.',
  ...
  'condense.copyIntro': 'Build a condensed copy beside the original tree: checked runs collapse into distill nodes (decisions and conclusions, highlights verbatim), everything else is copied as-is with wires rebuilt. The original is untouched; compare side by side, archive it when satisfied. Decision/pivot turns never collapse.',
  ...
  'condense.copyCompareHint': 'Compare the trees side by side: wire the same question to each and let the answers and token tags speak. The chip on a distill node jumps back to its source run. Archive the original when satisfied (dimmed, restorable anytime).',
