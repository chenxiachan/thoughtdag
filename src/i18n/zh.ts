...
export const zh: Record<keyof typeof en, string> = {
  ...
  'paradigm.emptyHint': '步骤里写的是提示词工程——指令、角色、流程——不是问题。这里不运行 LLM。乐谱写好后，实例化为对话画布去现场演奏。',
  'paradigm.addStep': '添加步骤',
  'paradigm.instantiate': '实例化为画布',
  'paradigm.instantiateTitle': '把这个范式变成可运行的对话画布（在你动手之前不会有任何生成）',
  'paradigm.kind.step': '步骤',
  'paradigm.kind.fanout': '扇出',
  'paradigm.kind.review': '评审',
  'paradigm.kind.synthesis': '综合',
  'paradigm.titlePlaceholder': '步骤名……',
  'paradigm.instructionPlaceholder': '指令（提示词工程）——实例化后成为该节点的问题……',
  'paradigm.rolePlaceholder': '此步骤的角色 / System Prompt（可选；点胶囊或自己写）……',
  'paradigm.fanoutRoles': '要扇出的视角（名称: 提示词，每行一个）',
