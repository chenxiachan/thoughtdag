...
export const en = {
  ...
  'fanout.entry': 'Fan out',
  'fanout.entryTitle': 'Fan out: ask one question through N isolated role perspectives at once',
  'fanout.title': 'Fan out into perspectives',
  'fanout.subtitle': 'One question, N parallel branches \u2014 each answers through its own role, blind to the others. The candidate pool for rule-in / rule-out.',
