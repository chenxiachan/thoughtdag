...
export const en = {
  ...
  'caps.enginePickTitle': 'Which Zhipu search engine handles web searches. The model still decides when to search; this decides how well.',
  ...
  'memory.importPlaceholder': 'Paste one memory per line. Copying your memory list from ChatGPT or Claude settings works as-is.',
