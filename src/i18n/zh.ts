...
export const zh: Record<keyof typeof en, string> = {
  ...
  'rerun.auto': '自动',
  'rerun.off': '关',
  'rerun.now': '立即重跑（按上游内容原地重新生成，保留版本）',
  'rerun.autoTitle': '自动重跑已开：上游任何内容完成后本节点自动重新生成',
  'rerun.offTitle': '自动重跑已关——点击开启',
  'rerun.toggleTitle': '自动重跑：上游变化时本节点自动重新生成——评审、活摘要、随动翻译都靠它',
