...
export const zh: Record<keyof typeof en, string> = {
  ...
  'tutorial.step1.desc': '一个问题就是一个节点：你的问题，加上 AI 的回答。下方输入、双击空白画布、或拖入一篇 PDF。',
  'tutorial.step2.title': '2 · 追问',
  'tutorial.step2.desc': '追问长出实线相连的子节点。AI 看到的，就是沿箭头流进来的全部上游。唯一法则：连线即上下文。',
  'tutorial.step3.title': '3 · 从选中文字分支',
  'tutorial.step3.desc': '选中回答里的一段话，点「探索」：橙色支线向侧面长出，继承上下文，不搅乱主线。',
  'tutorial.step4.title': '4 · 剪线与连线',
  'tutorial.step4.desc': '点选一条线再删除，那段历史就退出上下文；在节点间拖线，思路汇合。「将发送」预览随时给你看确切的上下文。',
  'tutorial.step5.title': '5 · 缩小看地图',
  'tutorial.step5.desc': '滚轮缩小：卡片折成一行收获句，关键一步戴上徽章——✕ 排除 · ⚖ 决策 · ↩ 转向 · ? 待解；再缩，只剩图章骨架。远看形状，近读全文。',
  'tutorial.step6.title': '6 · 材料与阅读器',
  'tutorial.step6.desc': '粘贴成便签、网址成快照、PDF 成文件节点。双击文件打开阅读器：圈选即问，答案带页码落回画布。不连线，不进上下文。',
  'tutorial.step7.title': '7 · 引用',
  'tutorial.step7.desc': '从节点把手拖线：落到已有节点，是紫色虚线引用——只带那份问答，带 token 价签，可切全量；落到空白处，就地新问。',
  'tutorial.step8.title': '8 · 批量与分区',
  'tutorial.step8.desc': '圈选多个节点：合并摘要、一起提问、整块复制、归档。用 Frame 框出章节，拖动框，里面的节点一起走。',
  'tutorial.step9.title': '9 · 陈旧与重放',
  'tutorial.step9.desc': '上游改了，下游亮琥珀徽章：这个回答基于旧内容。点徽章原地重答，旧版本保留可对比；工具栏一键重放全部，先报价再执行。',
