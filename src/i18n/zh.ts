...
export const zh: Record<keyof typeof en, string> = {
  ...
  'exp.take': '带去实验',
  'exp.takeTitle': '把这个节点的完整上下文编译成一段开场消息（含回程锚点）复制到剪贴板：在 CLI 新会话里粘贴即可带着图去实验，实验结束用 /thoughtdag harvest 收获回这里。',
  'exp.copied': '实验上下文已复制（{n} 段 · 约 {tok} tok）。在 CLI 新会话中粘贴为第一条消息；实验结束后运行 /thoughtdag harvest 收获回图。',
  ...
  'atlas.onCanvas': '已在画布',
  'atlas.openWith': '打开方式',
  'atlas.terminalChoice': '终端：',
  'atlas.preferApp': '{runner} 优先唤起 App（{name}）',
