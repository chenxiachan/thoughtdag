...
### 🔁 活节点 —— 一个原语，无数工具
任意节点都可以开启**自动重跑**：上游一有变化就重新生成自己。与角色组合，这一个开关就能长出审稿人、活摘要、随动翻译、常驻研究问题——不需要为每个场景单独造功能。**审稿人预设**一键完成组装：批评者人设 + 一条随思路延伸自动前移的红边，每一步新内容都会被重新评审（历史成版本）。而且审稿人就是普通节点——你可以反问它的批评、从批评里分支、把它连到任何地方。
