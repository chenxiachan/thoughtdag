...
export const en = {
  ...
  'tmap.shareHint': 'Xiaohongshu and Instagram have no web posting door: the button saves the image and copies the caption, paste it in the app. X and LinkedIn open directly.',
  ...
  'share.socialNote': 'Post with a thought map: shape and counts only, caption and platform doors included.',
