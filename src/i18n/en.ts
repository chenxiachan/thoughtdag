...
export const en = {
  ...
  'paradigm.emptyHint': 'Steps hold prompt engineering \u2014 instructions, roles, flow \u2014 not questions. No LLM runs here. When the score is ready, instantiate it as a chat canvas and perform it live.',
  'paradigm.addStep': 'Add step',
  ...
  'paradigm.kind.step': 'Step',
  'paradigm.kind.fanout': 'Fan-out',
  'paradigm.kind.review': 'Review',
  'paradigm.kind.synthesis': 'Synthesis',
  'paradigm.titlePlaceholder': 'Step title\u2026',
  'paradigm.instructionPlaceholder': 'Instruction (prompt engineering) \u2014 becomes the question when instantiated\u2026',
  'paradigm.rolePlaceholder': 'Role / system prompt for this step (optional; pick a chip or write your own)\u2026',
  'paradigm.fanoutRoles': 'Perspectives to fan out (Name: prompt, one per line)',
