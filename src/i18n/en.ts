...
export const en = {
  ...
  'provider.bridgeHostedNotice': 'The hosted app cannot reach your machine, so this door is unavailable here. Run ThoughtDAG locally to use it; the desktop app (in development) will make it one click. To start right now: one-click OpenRouter sign-in, or any API key.',
