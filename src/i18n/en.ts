...
export const en = {
  ...
  'rerun.label': 'Auto-rerun',
  'rerun.auto': 'Auto',
  'rerun.off': 'Off',
  'rerun.now': 'Rerun now (regenerate in place from upstream, keeps versions)',
  'rerun.autoTitle': 'Auto-rerun ON: this node regenerates whenever anything upstream finishes',
  'rerun.offTitle': 'Auto-rerun off \u2014 click to enable',
  'rerun.toggleTitle': 'Auto-rerun: regenerate this node whenever anything upstream changes \u2014 reviewers, live summaries, running translations',
