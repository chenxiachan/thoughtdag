...
export const en = {
  ...
  'reader.clipTitle': 'Drag a rectangle on the page: the area becomes its own image material on the canvas, with page provenance; wire it into a question and it goes to a vision model',
  'reader.clippedImage': 'Clipped as an image material, right beside the material node',
