...
export const zh: Record<keyof typeof en, string> = {
  ...
  'paradigm.humanHintPlaceholder': '给操作者的引导（可选）——实例化后这里是一个空问题节点，由人来提问……',
  'paradigm.promptPlaceholder': 'Prompt——处理上游节点流入的信息；实例化后成为待运行的问题……',
  'paradigm.rolePlaceholder': '此步骤的角色 / System Prompt（可选；点胶囊或自己写）……',
