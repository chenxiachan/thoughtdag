...
export const en = {
  ...
  'rerun.autoTitle': 'Auto-refresh ON \u2014 when anything upstream changes, this node regenerates itself. A reviewer always critiques the latest version; a summary always covers the latest discussion.',
