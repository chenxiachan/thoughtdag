...
export const en = {
  ...
  'paradigm.humanHintPlaceholder': 'Guidance for the operator (optional) \u2014 instantiates as an empty question node where the human asks\u2026',
  'paradigm.promptPlaceholder': 'Prompt \u2014 processes what flows in from upstream nodes; becomes a ready-to-run question on instantiation\u2026',
  'paradigm.rolePlaceholder': 'Role / system prompt for this step (optional; pick a chip or write your own)\u2026',
